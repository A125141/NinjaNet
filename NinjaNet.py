...
def main():
 ...
 _____   ______        ______    _________________  _____   ______    ____  _____   ______           ____        ____   
|\    \ |\     \   ___|\     \  /                 \|\    \ |\     \  |    ||\    \ |\     \         |    |  ____|\   \  
 \\    \| \     \ |     \     \ \______     ______/   \\    \| \     \ |      |\\    \| \     \        |    | /    /\    \ 
  \|    \  \     ||     ,_____/|   \( /    /  )/     \|    \  \     ||    |  \|    \  \     |       |    ||    |  |    |
   |     \  |    ||     \--'\_|/    ' |   |   '       |     \  |    ||    |   |     \  |    | ____  |    ||    |__|    |
   |      \ |    ||     /___/|        |   |           |      \ |    ||    |   |      \ |    ||    | |    ||    .--.    |
   |    |\ \|    ||     \____|\      /   //           |    |\ \|    ||    |   |    |\ \|    ||    | |    ||    |  |    |
   |____||\_____/||____ '     /|    /___//            |____||\_____/||____|   |____||\_____/||\____\|____||____|  |____|
   |    |/ \|   |||    /_____/ |   |`   |             |    |/ \|   |||    |   |    |/ \|   ||| |    |    ||    |  |    |
   |____|   |___|/|____|     | /   |____|             |____|   |___|/|____|   |____|   |___|/ \|____|____||____|  |____|
     \(       )/    \( |_____|/      \(                 \(       )/    \(       \(       )/      \(   )/    \(      )/  
      '       '      '    )/          '                  '       '      '        '       '        '   '      '      '   
                          '                                                                                             
''')
    ...
    print("      ")
    while True:
        print(Fore.RED + "[ 1 ]", Fore.YELLOW + "HACK A WIFI")
        print(Fore.RED + "[ 2 ]", Fore.YELLOW + "HELP")
        print(Fore.RED + "[ 3 ]", Fore.YELLOW + "Contact US for a problem")
        print(Fore.RED + "[ 0 ]", Fore.YELLOW + "EXIT")
        print(Fore.GREEN + "-----------------------------")
        print()
        option = input(Fore.YELLOW + "Select an option: ")
        ...
        if option == "1":
            ...
            time.sleep(1)
            print(Fore.GREEN + "-----------------------------")
            print(Fore.YELLOW + "Password Files:")
            print("   ")
